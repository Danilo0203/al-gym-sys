      ...
      <div className="flex w-full max-w-sm flex-col gap-6">
        ...
        <Card>
          <CardHeader className="text-center">
            <CardTitle className="text-xl">Verificación deshabilitada</CardTitle>
            <CardDescription>
              La verificación por correo quedó deshabilitada mientras esta app use autenticación local.
            </CardDescription>
          </CardHeader>
