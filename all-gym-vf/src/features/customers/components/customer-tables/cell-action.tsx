...
import { IconEdit, IconLoader2, IconTrash, IconUserCheck, IconUserOff } from "@tabler/icons-react";
...
import { useCustomer, useUpdateCustomerStatus } from "../../hooks/use-customers";
import { permanentlyDeleteCustomer } from "../../actions/customer-actions";
  ...
  return (
    <div onClick={(event) => event.stopPropagation()}>
      ...
      <AlertModal
        ...
        description="Esta acción sigue siendo legacy y eliminará al cliente de forma definitiva."
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                ...
                >
                  ...
                  <span className="sr-only">{data.is_active ? "Suspender cliente" : "Reactivar cliente"}</span>
                </Button>
              </TooltipTrigger>
              <TooltipContent>
                <p>{data.is_active ? "Suspender cliente" : "Reactivar cliente"}</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        ) : null}
